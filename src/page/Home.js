...
const Home = () => {
    ...
    useEffect(() => {
        ...
        axios
            ...
            .catch((error) => alert('Ocorreu um erro, por favor tente novamente'));
    ...
    return (
        <>
            ...
            <Footer>
                <h4> Desenvolvido por Hernán Barrientos </h4>
                <LinkFooter>
                    <CardNameDev>Hernán</CardNameDev>
                    <a target="_blank" href="https://www.linkedin.com/in/hernanesbarrientos/">
